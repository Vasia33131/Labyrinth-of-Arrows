...
namespace Unpuzzle
{
    ...
    public class DailyHintsPanel : MonoBehaviour
    {
        ...
        /// <summary>
        /// Требование 4.5.1: до клика кнопка называет и рекламу, и конкретную награду.
        /// Подпись собирается из тех же констант, что и выдача, чтобы не разъехаться.
        /// Текст в сцене («Получить за рекламу») — плейсхолдер и здесь перезаписывается.
        /// </summary>
        ...
        private void EnsureHierarchy()
        {
            ...
            {
                // Ниже банта: на светлой плашке карточки (оффер из GameScene).
                titleText = CreateLabel(card, "Title", GameTexts.HintsTitle,
                    new Vector2(0.5f, 1f), new Vector2(0.5f, 1f), new Vector2(0f, -335f), new Vector2(720f, 72f),
            ...
            if (card.Find("Message") == null)
            {
                messageText = CreateLabel(card, "Message", DailyPackMessage(),
                    new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new Vector2(0f, 100f), new Vector2(800f, 140f),
            ...
            if (card.Find("Balance") == null)
            {
                balanceText = CreateLabel(card, "Balance", GameTexts.BoosterBalance(0, 0, 0),
                    new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new Vector2(0f, -40f), new Vector2(800f, 140f),
            ...
            if (adButton == null)
            {
                adButton = CreateFaceButton(card, "AdButton",
                    ...
                    new Vector2(0f, -165f), new Vector2(720f, 148f), ResolveBtn(),
                    AdButtonText(BoosterKind.Hint), 32);
            }
            ...
            if (closeButton == null)
            {
                closeButton = CreateFaceButton(card, "CloseButton",
                    new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f),
                    new Vector2(0f, -315f), new Vector2(400f, 140f), ResolveBtn(), GameTexts.Ok, 44);
            }
