    ...
    public class BackgroundSlotView : MonoBehaviour
    {
        ...
        public void Bind(BackgroundData data, bool unlocked, bool selected, UnityAction onClick)
        {
            ...
            if (nameLabel != null)
            {
                ...
                nameLabel.text = GameTexts.BackgroundName(data.id, fallback);
            }
            ...
            if (actionLabel != null && !selected)
            {
                ...
                else if (data.IsFree) actionLabel.text = GameTexts.Buy;
                else actionLabel.text = GameTexts.Price(data.priceGold);
            }
