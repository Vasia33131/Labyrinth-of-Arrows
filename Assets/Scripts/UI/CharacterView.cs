...
namespace Unpuzzle
{
    ...
    public class CharacterView : MonoBehaviour
    {
        ...
        public void PlaySad()
        {
            Sprite sprite = sadSprite;
            Color tint = sadTint;
            CharacterSkinData skin = CharacterSkins.Selected;
            if (skin != null)
            {
                Sprite resolved = skin.ResolveSad(ArtLibrary.Current);
                if (resolved != null)
                {
                    sprite = resolved;
                    tint = skin.ColorForSad();
                    sadSprite = resolved;
                    sadTint = tint;
                }
            }

            ApplySprite(sprite != null ? sprite : idleSprite,
                sprite != null ? tint : idleTint);
