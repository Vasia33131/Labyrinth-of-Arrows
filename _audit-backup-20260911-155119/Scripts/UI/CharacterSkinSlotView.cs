    ...
    public class CharacterSkinSlotView : MonoBehaviour
    {
            ...
            bool adInProgress = false)
        {
            ...
            if (actionButton != null)
            {
                ...
                bool waitForAd = adInProgress && !unlocked && skin.unlockByRewarded;
                bool battlePassLocked = !unlocked && skin.unlockByBattlePass;
                actionButton.interactable = !selected && !waitForAd && !battlePassLocked;
            ...
            if (actionLabel != null)
            {
                ...
                else if (skin.unlockByRewarded) actionLabel.text = GameTexts.WatchAdForSkin;
                else actionLabel.text = skin.priceGold.ToString();
        ...
        public static CharacterSkinSlotView Create(Transform parent, CharacterSkinData skin)
        {
            ...
            view.preview = CreateImage(go.transform, "Preview",
                ...
                new Vector2(0f, 8f), new Vector2(380f, 348f));
            view.nameLabel = CreateLabel(go.transform, "Name", string.Empty,
                new Vector2(0.5f, 1f), new Vector2(0.5f, 1f), new Vector2(0.5f, 1f),
                new Vector2(0f, 14f), new Vector2(340f, 38f), TextAnchor.MiddleCenter, 30);
        ...
        private void LayoutParts()
        {
            ...
            Place(nameLabel != null ? nameLabel.rectTransform : null,
                new Vector2(0.5f, 1f), new Vector2(0.5f, 1f), new Vector2(0.5f, 1f),
                new Vector2(0f, 14f), new Vector2(340f, 38f));
