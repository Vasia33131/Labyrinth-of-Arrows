...
namespace Unpuzzle
{
    ...
    public class PlayModePanel : MonoBehaviour
    {
        ...
        private void ApplyTexts()
        {
            ...
            UiLabel.Set(backButton, GameTexts.Back);
        }
        ...
        private GameObject CreateSchoolPage(Transform card)
        {
            ...
            helpButton = CreateFaceButton(go.transform, "HelpButton",
                ...
                new Vector2(24f, -78f), new Vector2(80f, 80f), ResolveBtn(), "?", 40);
            ...
            gridRt.sizeDelta = new Vector2(720f, 620f);

            var layout = gridGo.AddComponent<GridLayoutGroup>();
            layout.padding = new RectOffset(8, 8, 8, 8);
            layout.cellSize = new Vector2(160f, 108f);
            ...
            backButton = CreateFaceButton(go.transform, "BackButton",
                new Vector2(0.5f, 0f), new Vector2(0.5f, 0f), new Vector2(0.5f, 0f),
                new Vector2(0f, 36f), new Vector2(400f, 120f), ResolveBtn(), GameTexts.Back, 36);
        ...
        private void EnsureSchoolSlots()
        {
            ...
            for (int i = levelGrid.childCount; i < SchoolLevelCatalog.TargetCount; i++)
            {
                ...
                Button button = CreateFaceButton(levelGrid, $"SchoolLevel_{level:D2}",
                    new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f),
                    Vector2.zero, new Vector2(160f, 108f), face, level.ToString(), 36);
        ...
        private void RepairCloseX()
        {
            ...
            var rt = closeXButton.transform as RectTransform;
            rt.anchorMin = new Vector2(1f, 1f);
            rt.anchorMax = new Vector2(1f, 1f);
            rt.pivot = new Vector2(1f, 1f);
        ...
        private void WireButtons()
        {
            ...
            if (backButton != null)
            {
                backButton.onClick.RemoveListener(ShowModePage);
                backButton.onClick.AddListener(ShowModePage);
            }
