...
namespace Unpuzzle
{
    ...
    public static class CharacterSkins
    {
        ...
        /// <summary>Открыть скин без оплаты. После rewarded вызывают UnlockSkin + Select.</summary>
        ...
        public static bool UnlockAndEquip(string id)
        {
            UnlockSkin(id);
            return Select(id);
        }
        ...
        public static bool TryBuyAndEquip(string id, out string failMessage)
        {
            ...
            {
                failMessage = GameTexts.WatchAdToUnlock;
                return false;
            }
