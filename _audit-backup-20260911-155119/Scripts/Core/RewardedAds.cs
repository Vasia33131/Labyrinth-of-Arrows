...
namespace Unpuzzle
{
    ...
    public static class RewardedAds
    {
        ...
        public const string SkinAd1Id = CharacterSkinCatalog.Ad1Id;
        public const string SkinAd2Id = CharacterSkinCatalog.Ad2Id;
        ...
        private static void Grant(string id)
        {
            ...
            else if (id == SkinAd1Id || id == SkinAd2Id)
            {
                CharacterSkins.UnlockSkin(id);
